...
echo "<h3>2. Tabelas recriadas (com Bio e Votos Únicos).</h3>";
...
echo "<h3>3. Usuários criados com Bios.</h3>";
...
echo "<h3>5. Conteúdo estendido gerado com sucesso!</h3>";
echo "<p class='lead'>Banco restaurado. Senha de todos: 123</p>";
echo "<hr>";
